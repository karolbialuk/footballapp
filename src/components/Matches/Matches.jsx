...
import { selectBookmark } from "../../features/currentBookmark";
...
function Matches() {
  ...
  const { data, error, isFetching } = useGetMatchesQuery(competitionId);
              ...
              <Grow in key={i} timeout={(i + 1) * 200}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Box sx={{ display: "flex" }}>
                        <Typography sx={{ color: "#fff", m: "0 10px" }}>
                      ...
                      {/* <BeenhereIcon
                        onClick={() => {
                          if (!bookmark.includes(match.fixture.id)) {
                            setBookmark((current) => [
                              ...current,
                              match.fixture.id,
                            ]);
                        ...
                        className={
                          bookmark.includes(match.fixture.id)
                            ? classes.favButton2
                            : classes.favButton
                        }
                      /> */}
